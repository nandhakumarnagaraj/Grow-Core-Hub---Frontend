        ...
        <form [formGroup]="profileForm" (ngSubmit)="onSubmit()" class="profile-form">
          ...
          <div class="form-section">
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <input id="name" type="text" [value]="profile.name" readonly class="form-input readonly">
              </div>
              <div class="form-group">
                <label for="email">Email</label>
                <input id="email" type="email" [value]="profile.email" readonly class="form-input readonly">
              </div>
            </div>
            <div class="form-row">
              <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea id="address" formControlName="address" class="form-textarea" rows="3"></textarea>
            </div>
          </div>
          ...
          <div class="form-section">
            ...
            <div formArrayName="skills" class="skills-list">
              <div *ngFor="let skillForm of skillsFormArray.controls; let i = index" 
                   [formGroupName]="i" class="skill-item">
                <div class="skill-form-row">
                  <div class="form-group">
                    <input type="text" formControlName="name" placeholder="Skill name" class="form-input">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <input type="number" formControlName="yearsOfExperience" 
                           placeholder="Years" class="form-input" min="0">
                  </div>
                  <button type="button" class="btn btn-danger-outline" (click)="removeSkill(i)">Remove</button>
                </div>
              </div>
            </div>
          ...
          <div class="form-section">
            ...
            <div formArrayName="education" class="education-list">
              <div *ngFor="let eduForm of educationFormArray.controls; let i = index" 
                ...
                <div class="education-form">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" formControlName="graduationYear" class="form-input" 
                             [min]="1950" [max]="2030">
                    </div>
                  </div>
          ...
          <div class="form-section">
            ...
            <div class="documents-list" *ngIf="profile.documents.length > 0">
              <div *ngFor="let doc of profile.documents" class="document-item">
                ...
                <div class="doc-actions">
                  ...
                  <button type="button" class="btn btn-sm btn-danger-outline" (click)="removeDocument(doc)">
                    Delete
                  </button>
                </div>
              </div>
